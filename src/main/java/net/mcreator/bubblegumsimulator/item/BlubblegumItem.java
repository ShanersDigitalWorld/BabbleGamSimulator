...
public class BlubblegumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:blubblegum")
	public static final Item block = null;
	public BlubblegumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 126);
	}
	...
	private static class ItemToolCustom extends Item {
		...
		public float getDestroySpeed(ItemStack itemstack, BlockState blockstate) {
			if (blockstate.getBlock() == VipBlock.block.getDefaultState().getBlock())
				return 0f;
			return 1;
		}
