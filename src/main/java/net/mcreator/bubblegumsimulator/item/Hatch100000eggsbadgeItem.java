...
public class Hatch100000eggsbadgeItem extends BubbleGumSimulatorModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(BgshatchbadgesItemGroup.tab).maxStackSize(64).rarity(Rarity.RARE));
			setRegistryName("hatch_100000eggsbadge");
		}
