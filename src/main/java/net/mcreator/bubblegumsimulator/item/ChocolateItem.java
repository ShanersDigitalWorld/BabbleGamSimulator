...
import net.mcreator.bubblegumsimulator.procedures.ChocolatebubbleproProcedure;
...
public class ChocolateItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:chocolate")
	public static final Item block = null;
	public ChocolateItem(BubbleGumSimulatorModElements instance) {
		super(instance, 132);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					ChocolatebubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
