...
import net.mcreator.bubblegumsimulator.procedures.PizzabubbleproProcedure;
...
public class PizzaItem extends BubbleGumSimulatorModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					PizzabubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
