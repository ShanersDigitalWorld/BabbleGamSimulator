...
import net.mcreator.bubblegumsimulator.procedures.VipbubbleproProcedure;
...
public class VipflavorItem extends BubbleGumSimulatorModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					VipbubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("vipflavor"));
	}
