...
import net.mcreator.bubblegumsimulator.procedures.GoldbubbleproProcedure;
...
public class GoldflavorItem extends BubbleGumSimulatorModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					GoldbubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("goldflavor"));
	}
