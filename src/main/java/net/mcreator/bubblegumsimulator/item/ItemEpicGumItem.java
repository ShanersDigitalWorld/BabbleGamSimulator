...
public class ItemEpicGumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:item_epic_gum")
	public static final Item block = null;
	public ItemEpicGumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 423);
	}
