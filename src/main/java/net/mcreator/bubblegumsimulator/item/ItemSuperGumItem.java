...
public class ItemSuperGumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:item_super_gum")
	public static final Item block = null;
	public ItemSuperGumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 424);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_super_gum");
		}
