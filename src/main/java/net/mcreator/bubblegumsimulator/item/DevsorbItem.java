...
public class DevsorbItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:devsorb")
	public static final Item block = null;
	public DevsorbItem(BubbleGumSimulatorModElements instance) {
		super(instance, 508);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DevGuiGui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dev Orb Item");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DevGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
