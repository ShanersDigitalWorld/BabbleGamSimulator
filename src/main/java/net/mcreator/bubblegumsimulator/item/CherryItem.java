...
import net.mcreator.bubblegumsimulator.procedures.CherrybubbleproProcedure;
...
public class CherryItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:cherry")
	public static final Item block = null;
	public CherryItem(BubbleGumSimulatorModElements instance) {
		super(instance, 291);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					CherrybubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
