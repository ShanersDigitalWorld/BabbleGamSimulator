...
import net.mcreator.bubblegumsimulator.procedures.DonutbubbleproProcedure;
...
public class DonutItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:donut")
	public static final Item block = null;
	public DonutItem(BubbleGumSimulatorModElements instance) {
		super(instance, 292);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					DonutbubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
