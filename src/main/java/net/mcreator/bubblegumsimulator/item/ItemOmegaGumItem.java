...
public class ItemOmegaGumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:item_omega_gum")
	public static final Item block = null;
	public ItemOmegaGumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 426);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_omega_gum");
		}
