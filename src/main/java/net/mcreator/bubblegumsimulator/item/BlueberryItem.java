...
import net.mcreator.bubblegumsimulator.procedures.BlueberrybubbleproProcedure;
...
public class BlueberryItem extends BubbleGumSimulatorModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					BlueberrybubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
