...
public class DevItemItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:dev_item")
	public static final Item block = null;
	public DevItemItem(BubbleGumSimulatorModElements instance) {
		super(instance, 504);
	}
