...
import net.mcreator.bubblegumsimulator.procedures.SwirlbubbleproProcedure;
...
public class SwirlItem extends BubbleGumSimulatorModElements.ModElement {
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
				...
				World world = entity.world;
				{
					...
					SwirlbubbleproProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setRegistryName("swirl"));
	}
