...
public class ObscureItem extends BubbleGumSimulatorModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(BgsItemGroup.tab).maxStackSize(64).rarity(Rarity.EPIC));
			setRegistryName("obscure");
		}
