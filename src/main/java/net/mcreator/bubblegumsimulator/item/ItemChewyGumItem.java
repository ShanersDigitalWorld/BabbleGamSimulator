...
public class ItemChewyGumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:item_chewy_gum")
	public static final Item block = null;
	public ItemChewyGumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 421);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_chewy_gum");
		}
