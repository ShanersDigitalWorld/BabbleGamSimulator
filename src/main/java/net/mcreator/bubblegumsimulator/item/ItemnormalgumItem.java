...
public class ItemnormalgumItem extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:itemnormalgum")
	public static final Item block = null;
	public ItemnormalgumItem(BubbleGumSimulatorModElements instance) {
		super(instance, 412);
	}
