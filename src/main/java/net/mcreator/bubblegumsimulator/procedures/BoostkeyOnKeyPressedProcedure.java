...
public class BoostkeyOnKeyPressedProcedure extends BubbleGumSimulatorModElements.ModElement {
	public BoostkeyOnKeyPressedProcedure(BubbleGumSimulatorModElements instance) {
		super(instance, 354);
	}
			...
			if (_ent instanceof ServerPlayerEntity) {
				...
				NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Guiboosts");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new GuiboostsGui.GuiContainerMod(id, inventory, new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
