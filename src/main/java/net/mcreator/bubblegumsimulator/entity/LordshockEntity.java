...
public class LordshockEntity extends BubbleGumSimulatorModElements.ModElement {
	public static EntityType entity = null;
	public LordshockEntity(BubbleGumSimulatorModElements instance) {
		super(instance, 535);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("lordshock")
						.setRegistryName("lordshock");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -39424, -205, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("lordshock_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRBShock(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bubble_gum_simulator:textures/thelordshock.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Lord Shock"));
