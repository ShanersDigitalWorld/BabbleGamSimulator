...
public class RbshockentEntity extends BubbleGumSimulatorModElements.ModElement {
	public static EntityType entity = null;
	public RbshockentEntity(BubbleGumSimulatorModElements instance) {
		super(instance, 532);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("rbshockent")
						.setRegistryName("rbshockent");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -3407872, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("rbshockent_spawn_egg"));
	}
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelRBShock(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("bubble_gum_simulator:textures/rbshock.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("Rainbow Shock"));
	...
	public static class ModelRBShock extends EntityModel<Entity> {
