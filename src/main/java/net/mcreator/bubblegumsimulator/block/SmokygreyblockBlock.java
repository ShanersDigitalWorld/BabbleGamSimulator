...
public class SmokygreyblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:smokygreyblock")
	public static final Block block = null;
	public SmokygreyblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smokygreyblock");
		}
