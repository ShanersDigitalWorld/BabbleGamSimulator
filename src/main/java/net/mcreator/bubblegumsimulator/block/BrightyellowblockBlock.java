...
public class BrightyellowblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:brightyellowblock")
	public static final Block block = null;
	public BrightyellowblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 87);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brightyellowblock");
		}
