...
public class Sellblock6Block extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:sellblock_6")
	public static final Block block = null;
	public Sellblock6Block(BubbleGumSimulatorModElements instance) {
		super(instance, 481);
	}
