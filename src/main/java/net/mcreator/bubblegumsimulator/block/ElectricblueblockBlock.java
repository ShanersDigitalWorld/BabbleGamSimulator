...
public class ElectricblueblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:electricblueblock")
	public static final Block block = null;
	public ElectricblueblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("electricblueblock");
		}
