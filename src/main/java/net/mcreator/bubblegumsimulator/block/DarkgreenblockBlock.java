...
public class DarkgreenblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:darkgreenblock")
	public static final Block block = null;
	public DarkgreenblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkgreenblock");
		}
