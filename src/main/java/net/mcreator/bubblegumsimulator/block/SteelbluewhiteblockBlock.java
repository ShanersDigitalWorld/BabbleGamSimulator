...
public class SteelbluewhiteblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:steelbluewhiteblock")
	public static final Block block = null;
	public SteelbluewhiteblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("steelbluewhiteblock");
		}
