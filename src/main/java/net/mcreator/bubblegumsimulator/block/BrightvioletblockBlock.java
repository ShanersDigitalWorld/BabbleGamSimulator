...
public class BrightvioletblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:brightvioletblock")
	public static final Block block = null;
	public BrightvioletblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brightvioletblock");
		}
