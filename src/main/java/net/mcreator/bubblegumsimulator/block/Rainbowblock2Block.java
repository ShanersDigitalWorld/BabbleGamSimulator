...
public class Rainbowblock2Block extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:rainbowblock_2")
	public static final Block block = null;
	public Rainbowblock2Block(BubbleGumSimulatorModElements instance) {
		super(instance, 382);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rainbowblock_2");
		}
