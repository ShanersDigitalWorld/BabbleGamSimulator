...
public class MediumbluewhiteslabBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:mediumbluewhiteslab")
	public static final Block block = null;
	public MediumbluewhiteslabBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mediumbluewhiteslab");
		}
