...
public class EarthgreenblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:earthgreenblock")
	public static final Block block = null;
	public EarthgreenblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("earthgreenblock");
		}
