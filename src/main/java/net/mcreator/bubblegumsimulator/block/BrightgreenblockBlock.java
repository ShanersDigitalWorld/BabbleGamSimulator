...
public class BrightgreenblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:brightgreenblock")
	public static final Block block = null;
	public BrightgreenblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brightgreenblock");
		}
