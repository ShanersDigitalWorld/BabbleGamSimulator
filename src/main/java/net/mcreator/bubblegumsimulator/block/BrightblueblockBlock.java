...
public class BrightblueblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:brightblueblock")
	public static final Block block = null;
	public BrightblueblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brightblueblock");
		}
