...
public class BlackwhiteblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:blackwhiteblock")
	public static final Block block = null;
	public BlackwhiteblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blackwhiteblock");
		}
