...
import net.mcreator.bubblegumsimulator.procedures.Protesthatch2petsProcedure;
...
public class Test2pethatchBlock extends BubbleGumSimulatorModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("test_2pethatch");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				Protesthatch2petsProcedure.executeProcedure($_dependencies);
			}
