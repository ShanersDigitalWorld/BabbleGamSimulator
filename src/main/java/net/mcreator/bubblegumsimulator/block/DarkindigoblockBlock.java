...
public class DarkindigoblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:darkindigoblock")
	public static final Block block = null;
	public DarkindigoblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 31);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkindigoblock");
		}
