...
public class DaisyorangeblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:daisyorangeblock")
	public static final Block block = null;
	public DaisyorangeblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("daisyorangeblock");
		}
