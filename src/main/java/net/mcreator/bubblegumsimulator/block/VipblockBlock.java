...
public class VipblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:vipblock")
	public static final Block block = null;
	public VipblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 380);
	}
