...
public class ElectricBlueSlabBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:electric_blue_slab")
	public static final Block block = null;
	public ElectricBlueSlabBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 480);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("electric_blue_slab");
		}
