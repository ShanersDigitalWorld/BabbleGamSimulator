...
public class Sellblock7Block extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:sellblock_7")
	public static final Block block = null;
	public Sellblock7Block(BubbleGumSimulatorModElements instance) {
		super(instance, 482);
	}
