...
public class BrightredblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:brightredblock")
	public static final Block block = null;
	public BrightredblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brightredblock");
		}
