...
public class ReallyredblockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:reallyredblock")
	public static final Block block = null;
	public ReallyredblockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reallyredblock");
		}
