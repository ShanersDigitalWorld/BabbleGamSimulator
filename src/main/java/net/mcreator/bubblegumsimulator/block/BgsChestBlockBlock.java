...
public class BgsChestBlockBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:bgs_chest_block")
	public static final Block block = null;
	public BgsChestBlockBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 488);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bgs_chest_block");
		}
