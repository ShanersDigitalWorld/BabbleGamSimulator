...
public class TestSaveBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:test_save")
	public static final Block block = null;
	public TestSaveBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 549);
	}
