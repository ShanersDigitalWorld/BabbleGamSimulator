...
public class BeeswarmaBlock extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:beeswarma")
	public static final Block block = null;
	public BeeswarmaBlock(BubbleGumSimulatorModElements instance) {
		super(instance, 542);
	}
