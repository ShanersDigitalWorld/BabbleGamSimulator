...
package net.mcreator.bubblegumsimulator.particle;
...
public class BubblinpartsParticle extends BubbleGumSimulatorModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public BubblinpartsParticle(BubbleGumSimulatorModElements instance) {
		super(instance, 369);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("bubblinparts"));
	}
