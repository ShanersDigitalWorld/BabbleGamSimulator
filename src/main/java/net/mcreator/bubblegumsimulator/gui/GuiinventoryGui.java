...
public class GuiinventoryGui extends BubbleGumSimulatorModElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("guiinventory"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("bubble_gum_simulator:textures/guiinventory.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("bubble_gum_simulator:textures/untitled-12.png"));
			this.blit(this.guiLeft + 9, this.guiTop + -12, 0, 0, 158, 12, 158, 12);
		}
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("" + (entity.getPersistentData().getString("Petname")) + "", 4, 6, -3407872);
			this.font.drawString("" + (entity.getPersistentData().getBoolean("Petstate")) + "", 21, 34, -205);
			this.font.drawString("" + (entity.getPersistentData().getDouble("Petenchant")) + "", 4, 15, -1);
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + -54, this.guiTop + 99, 55, 20, "Delete", e -> {
				BubbleGumSimulatorMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + -103, this.guiTop + 99, 50, 20, "Equip", e -> {
				BubbleGumSimulatorMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + -85, this.guiTop + 118, 60, 20, "Enchant", e -> {
				BubbleGumSimulatorMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(2, x, y, z));
				handleButtonAction(entity, 2, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 143, this.guiTop + 2, 30, 20, "X", e -> {
				BubbleGumSimulatorMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(3, x, y, z));
				handleButtonAction(entity, 3, x, y, z);
			}));
			Search = new TextFieldWidget(this.font, this.guiLeft + -120, this.guiTop + 2, 120, 20, "");
