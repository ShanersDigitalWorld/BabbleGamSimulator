...
public class Tradescreen1Gui extends BubbleGumSimulatorModElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("tradescreen_1"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private int x, y, z;
		private PlayerEntity entity;
		TextFieldWidget searchyourtradeinv;
		TextFieldWidget searchtraderinv;
		...
		public void render(int mouseX, int mouseY, float partialTicks) {
			...
			searchyourtradeinv.render(mouseX, mouseY, partialTicks);
			searchtraderinv.render(mouseX, mouseY, partialTicks);
		}
		...
		public boolean keyPressed(int key, int b, int c) {
			...
			if (searchyourtradeinv.isFocused())
				return searchyourtradeinv.keyPressed(key, b, c);
			if (searchtraderinv.isFocused())
				return searchtraderinv.keyPressed(key, b, c);
		...
		public void tick() {
			super.tick();
			searchyourtradeinv.tick();
			searchtraderinv.tick();
		}
