...
import net.mcreator.bubblegumsimulator.procedures.InvkeyOnKeyPressedProcedure;
...
public class InvkeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.invkey", GLFW.GLFW_KEY_KP_9, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				InvkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
