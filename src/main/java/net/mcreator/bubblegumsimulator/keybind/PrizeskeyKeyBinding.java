...
import net.mcreator.bubblegumsimulator.procedures.PrizeskeyOnKeyPressedProcedure;
...
public class PrizeskeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.prizeskey", GLFW.GLFW_KEY_R, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				PrizeskeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
