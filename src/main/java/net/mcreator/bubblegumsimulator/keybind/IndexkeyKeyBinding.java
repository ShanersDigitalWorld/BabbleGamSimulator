...
import net.mcreator.bubblegumsimulator.procedures.IndexkeyOnKeyPressedProcedure;
...
public class IndexkeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.indexkey", GLFW.GLFW_KEY_I, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				IndexkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
