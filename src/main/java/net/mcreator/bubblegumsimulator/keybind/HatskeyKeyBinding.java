...
import net.mcreator.bubblegumsimulator.procedures.HatskeyOnKeyPressedProcedure;
...
public class HatskeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.hatskey", GLFW.GLFW_KEY_H, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				HatskeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
