...
public class HatchautoKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.hatchauto", GLFW.GLFW_KEY_E, "key.categories.misc");
