...
import net.mcreator.bubblegumsimulator.procedures.TradingkeyOnKeyPressedProcedure;
...
public class TradingkeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.tradingkey", GLFW.GLFW_KEY_T, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				TradingkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
