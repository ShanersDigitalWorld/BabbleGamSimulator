...
import net.mcreator.bubblegumsimulator.procedures.ShopkeyOnKeyPressedProcedure;
...
public class ShopkeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.shopkey", GLFW.GLFW_KEY_S, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				ShopkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
