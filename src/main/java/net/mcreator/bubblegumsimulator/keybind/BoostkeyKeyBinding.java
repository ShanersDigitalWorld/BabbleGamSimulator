...
import net.mcreator.bubblegumsimulator.procedures.BoostkeyOnKeyPressedProcedure;
...
public class BoostkeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.boostkey", GLFW.GLFW_KEY_B, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				BoostkeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
