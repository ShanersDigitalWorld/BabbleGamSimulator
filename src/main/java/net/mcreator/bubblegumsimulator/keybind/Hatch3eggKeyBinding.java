...
public class Hatch3eggKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public Hatch3eggKeyBinding(BubbleGumSimulatorModElements instance) {
		super(instance, 205);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.hatch_3egg", GLFW.GLFW_KEY_E, "key.categories.inventory");
