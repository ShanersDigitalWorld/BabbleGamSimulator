...
import net.mcreator.bubblegumsimulator.procedures.SettingskeyOnKeyPressedProcedure;
...
public class SettingskeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.settingskey", GLFW.GLFW_KEY_M, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				SettingskeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
