...
import net.mcreator.bubblegumsimulator.procedures.PetskeyOnKeyPressedProcedure;
...
public class PetskeyKeyBinding extends BubbleGumSimulatorModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.petskey", GLFW.GLFW_KEY_P, "key.categories.misc");
		...
		if (type == 0) {
			{
				...
				PetskeyOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
