...
import net.mcreator.bubblegumsimulator.block.ReallyredblockBlock;
import net.mcreator.bubblegumsimulator.BubbleGumSimulatorModElements;

@BubbleGumSimulatorModElements.ModElement.Tag
public class RainbowbioBiome extends BubbleGumSimulatorModElements.ModElement {
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SeagreenblockBlock.block.getDefaultState(),
								ReallyredblockBlock.block.getDefaultState(), ReallyredblockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("bubble_gum_simulator:rainbowbio"));
			}
		}
	}
	@Override
