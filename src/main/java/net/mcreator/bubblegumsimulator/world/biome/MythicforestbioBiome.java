...
public class MythicforestbioBiome extends BubbleGumSimulatorModElements.ModElement {
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SeagreenblockBlock.block.getDefaultState(),
								RoyalpurpleblockBlock.block.getDefaultState(), RoyalpurpleblockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("bubble_gum_simulator:mythicforestbio"));
			}
		}
	}
	@Override
