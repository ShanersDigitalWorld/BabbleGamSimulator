...
public class UnderworldbioBiome extends BubbleGumSimulatorModElements.ModElement {
	public static Biome biome;
	public UnderworldbioBiome(BubbleGumSimulatorModElements instance) {
		super(instance, 151);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ReddishbrownblockBlock.block.getDefaultState(),
								DeeporangeblockBlock.block.getDefaultState(), DeeporangeblockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("bubble_gum_simulator:underworldbio"));
			}
		}
	}
	@Override
