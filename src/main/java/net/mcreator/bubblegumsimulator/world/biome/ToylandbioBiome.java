...
public class ToylandbioBiome extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:toylandbio")
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			super(new Biome.Builder().downfall(0.5f).depth(0.1f).scale(0.2f).temperature(0.5f).precipitation(Biome.RainType.RAIN)
					...
					.surfaceBuilder(SurfaceBuilder.DEFAULT, new SurfaceBuilderConfig(LimegreenblockBlock.block.getDefaultState(),
							RustblockBlock.block.getDefaultState(), RustblockBlock.block.getDefaultState())));
			setRegistryName("toylandbio");
