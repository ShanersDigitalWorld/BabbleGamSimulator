...
public class ToylandbioBiome extends BubbleGumSimulatorModElements.ModElement {
	public static Biome biome;
	public ToylandbioBiome(BubbleGumSimulatorModElements instance) {
		super(instance, 147);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(LimegreenblockBlock.block.getDefaultState(),
								RustblockBlock.block.getDefaultState(), RustblockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("bubble_gum_simulator:toylandbio"));
			}
		}
	}
	@Override
