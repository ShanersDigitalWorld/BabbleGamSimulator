...
import net.mcreator.bubblegumsimulator.block.FawnbrownblockBlock;
import net.mcreator.bubblegumsimulator.BubbleGumSimulatorModElements;

@BubbleGumSimulatorModElements.ModElement.Tag
public class AtlantisbioBiome extends BubbleGumSimulatorModElements.ModElement {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SeagreenblockBlock.block.getDefaultState(),
								FawnbrownblockBlock.block.getDefaultState(), FawnbrownblockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("bubble_gum_simulator:atlantisbio"));
			}
		}
	}
	@Override
