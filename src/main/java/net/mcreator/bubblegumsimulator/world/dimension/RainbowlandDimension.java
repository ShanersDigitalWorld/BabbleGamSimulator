...
import net.mcreator.bubblegumsimulator.procedures.RainbowPlayerEntersDimensionmusicProcedure;
import net.mcreator.bubblegumsimulator.item.RainbowlandItem;
...
public class RainbowlandDimension extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:rainbowland")
	public static final ModDimension dimension = null;
	@ObjectHolder("bubble_gum_simulator:rainbowland_portal")
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("rainbowland"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("bubble_gum_simulator:rainbowland")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("bubble_gum_simulator:rainbowland"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("bubble_gum_simulator:rainbowland"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("bubble_gum_simulator:rainbowbio")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new RainbowlandItem().setRegistryName("rainbowland"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("rainbowland_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = RainbowlandDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("rainbowland_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "rainbowland_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = RainbowlandDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		if (event.getTo() == type) {
			{
				...
				RainbowPlayerEntersDimensionmusicProcedure.executeProcedure($_dependencies);
			}
		}
	}
