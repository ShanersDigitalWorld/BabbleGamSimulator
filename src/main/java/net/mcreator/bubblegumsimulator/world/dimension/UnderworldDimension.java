...
import net.mcreator.bubblegumsimulator.item.UnderworldItem;
import net.mcreator.bubblegumsimulator.block.ReddishbrownblockBlock;
...
public class UnderworldDimension extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:underworld")
	public static final ModDimension dimension = null;
	@ObjectHolder("bubble_gum_simulator:underworld_portal")
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("bubble_gum_simulator:underworld")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("bubble_gum_simulator:underworld"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("bubble_gum_simulator:underworld"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = UnderworldDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "underworld_portal",
	...
	public static class TeleporterDimensionMod implements ITeleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = UnderworldDimension.CustomPortalBlock.createPatternHelper(this.world,
						blockpos);
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new EndGenerationSettings() {
				public BlockState getDefaultBlock() {
					return ReddishbrownblockBlock.block.getDefaultState();
				}
