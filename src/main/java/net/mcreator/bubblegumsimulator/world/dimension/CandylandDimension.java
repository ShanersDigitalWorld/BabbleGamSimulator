...
import net.mcreator.bubblegumsimulator.procedures.CandylandPlayerEntersDimensionmusicProcedure;
import net.mcreator.bubblegumsimulator.item.CandylandItem;
...
import net.mcreator.bubblegumsimulator.block.CarnationpinkblockBlock;
...
public class CandylandDimension extends BubbleGumSimulatorModElements.ModElement {
	@ObjectHolder("bubble_gum_simulator:candyland")
	public static final ModDimension dimension = null;
	@ObjectHolder("bubble_gum_simulator:candyland_portal")
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("bubble_gum_simulator:candyland")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("bubble_gum_simulator:candyland"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("bubble_gum_simulator:candyland"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("bubble_gum_simulator:candylandbio")),};
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = CandylandDimension.CustomPortalBlock.createPatternHelper(entity.world, pos);
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("candyland_portal", Vec3i::compareTo, 300);
	@SubscribeEvent
		...
		if (event.getTo() == type) {
			{
				...
				CandylandPlayerEntersDimensionmusicProcedure.executeProcedure($_dependencies);
			}
		}
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new EndGenerationSettings() {
				public BlockState getDefaultBlock() {
					return CarnationpinkblockBlock.block.getDefaultState();
				}

				public BlockState getDefaultFluid() {
					return PersimmonblockBlock.block.getDefaultState();
				}
			});
